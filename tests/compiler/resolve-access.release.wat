(module
 ...
 (data $21 (i32.const 3488) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\02\00\00\02\t\00\00 ")
 ...
 (func $~lib/number/U64#toString (param $0 i64) (result i32)
  ...
  i32.const 0
  i32.store
  block $__inlined_func$~lib/util/number/utoa64$75
   local.get $0
   i64.eqz
   if
    global.get $~lib/memory/__stack_pointer
    ...
    i32.const 1408
    local.set $2
    br $__inlined_func$~lib/util/number/utoa64$75
   end
   local.get $0
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$154
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1152
     local.set $0
     br $__inlined_func$~lib/string/String#concat$154
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
