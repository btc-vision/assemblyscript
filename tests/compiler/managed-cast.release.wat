(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36460))
 (memory $0 1)
 ...
 (data $19.1 (i32.const 3416) "\02\00\00\00^\00\00\00U\00n\00e\00x\00p\00e\00c\00t\00e\00d\00 \00\'\00n\00u\00l\00l\00\'\00 \00(\00n\00o\00t\00 \00a\00s\00s\00i\00g\00n\00e\00d\00 \00o\00r\00 \00f\00a\00i\00l\00e\00d\00 \00c\00a\00s\00t\00)")
 (data $20 (i32.const 3532) "<")
 (data $20.1 (i32.const 3544) "\02\00\00\00\1e\00\00\00m\00a\00n\00a\00g\00e\00d\00-\00c\00a\00s\00t\00.\00t\00s")
 (data $21 (i32.const 3596) "<")
 (data $21.1 (i32.const 3608) "\02\00\00\00 \00\00\00i\00n\00v\00a\00l\00i\00d\00 \00d\00o\00w\00n\00c\00a\00s\00t")
 (data $22 (i32.const 3664) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 ")
 ...
 (func $~start
  ...
  block $folding-inner0
   ...
   i64.const 0
   i64.store
   block $__inlined_func$~instanceof|managed-cast/Cat$89 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=4
    i32.const 0
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$89
    drop
    i32.const 1
   end
   i32.eqz
   ...
   i32.const 0
   i32.store offset=8
   block $__inlined_func$~instanceof|managed-cast/Cat$92 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=4
    global.get $~lib/memory/__stack_pointer
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$92
    drop
    i32.const 1
   end
   i32.eqz
   ...
   i32.store offset=8
   global.get $~lib/memory/__stack_pointer
   block $__inlined_func$~instanceof|managed-cast/Cat$95 (result i32)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
    i32.const 0
    ...
    i32.const 4
    i32.ne
    br_if $__inlined_func$~instanceof|managed-cast/Cat$95
    drop
    i32.const 1
   end
   i32.eqz
