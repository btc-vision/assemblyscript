(module
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$905
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$905
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  ...
  if
   ...
   block $__inlined_func$~lib/rt/itcms/__renew$888
    local.get $4
    i32.const 20
    i32.sub
    local.tee $3
    ...
    if
     ...
     local.get $4
     local.set $2
     br $__inlined_func$~lib/rt/itcms/__renew$888
    end
    local.get $1
    local.get $3
    i32.load offset=12
