(module
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$1423
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$1423
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  ...
  if
   ...
   block $__inlined_func$~lib/rt/itcms/__renew$1372
    local.get $4
    i32.const 20
    i32.sub
    local.tee $3
    ...
    if
     ...
     local.get $4
     local.set $2
     br $__inlined_func$~lib/rt/itcms/__renew$1372
    end
    local.get $1
    local.get $3
    i32.load offset=12
 ...
 (func $"~lib/map/Map<i8,i8>#set" (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<i8,i8>#find$1373"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<i8,i8>#find$1373"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<u8,u8>#set" (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<u8,u8>#find$1378"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<u8,u8>#find$1378"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<i16,i16>#set" (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<i16,i16>#find$1383"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<i16,i16>#find$1383"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<u16,u16>#set" (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<u16,u16>#find$1388"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<u16,u16>#find$1388"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<i64,i64>#set" (param $0 i32) (param $1 i64) (param $2 i64)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<i64,i64>#find$1398"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<i64,i64>#find$1398"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<u64,u64>#set" (param $0 i32) (param $1 i64) (param $2 i64)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<u64,u64>#find$1403"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<u64,u64>#find$1403"
      end
      local.get $4
      i32.const -2
      i32.and
 ...
 (func $"~lib/map/Map<f64,f64>#set" (param $0 i32) (param $1 f64) (param $2 f64)
  ...
  block $folding-inner1
   ...
   i32.load
   local.set $3
   block $"__inlined_func$~lib/map/Map<f64,f64>#find$1413"
    loop $while-continue|0
     local.get $3
     if
      local.get $3
      ...
      if
       ...
       i32.add
       global.set $~lib/memory/__stack_pointer
       br $"__inlined_func$~lib/map/Map<f64,f64>#find$1413"
      end
      local.get $4
      i32.const -2
      i32.and
