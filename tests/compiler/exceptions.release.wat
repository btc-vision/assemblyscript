(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34504))
 (memory $0 1)
 ...
 (data $16 (i32.const 1712) "\05\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~start
  ...
  i32.const 1296
  global.set $~lib/rt/itcms/fromSpace
  block $__inlined_func$exceptions/testTryCatch$121
   try
    i32.const 1472
    call $~lib/error/Error#constructor
    throw $$error
    ...
    drop
    br $__inlined_func$exceptions/testTryCatch$121
   end
   unreachable
  end
  global.get $~lib/memory/__stack_pointer
  ...
  i32.const 0
  i32.store
  block $__inlined_func$exceptions/testCatchVar$122
   try
    i32.const 1552
    call $~lib/error/Error#constructor
    throw $$error
    ...
    i32.add
    global.set $~lib/memory/__stack_pointer
    br $__inlined_func$exceptions/testCatchVar$122
   end
   unreachable
  end
  global.get $~lib/memory/__stack_pointer
  ...
  block $__inlined_func$exceptions/testNested$125
   try
    try
     i32.const 1584
     call $~lib/error/Error#constructor
    ...
    drop
    br $__inlined_func$exceptions/testNested$125
   end
   unreachable
  end
  try $try_finally|07
  ...
  block $__inlined_func$exceptions/testFinallyWithException$127
   try
    try $try_finally|010
     i32.const 1680
     call $~lib/error/Error#constructor
    ...
    i32.ne
    local.set $0
    br $__inlined_func$exceptions/testFinallyWithException$127
   end
   unreachable
  end
  local.get $0
